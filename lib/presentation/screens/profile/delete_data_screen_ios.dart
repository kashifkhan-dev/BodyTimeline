  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        middle: const Text('Delete Data', style: TextStyle(color: CupertinoColors.destructiveRed)),
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: CupertinoColors.label),
              ),
              const SizedBox(height: 16),
              const Text(
                'This action is irreversible. All photos, logs, progress, and settings will be permanently removed from this device.',
                style: TextStyle(fontSize: 17, color: CupertinoColors.secondaryLabel, height: 1.4),
              ),
